...
final class lucida_upgrade_pro_customize {
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_script( 'lucida-upgrade-button-customize-controls', trailingslashit( get_template_directory_uri() ) . 'inc/customizer-includes/upgrade-button/customize-controls.js', array( 'customize-controls' ) );

		wp_enqueue_style( 'lucida-upgrade-button-customize-controls', trailingslashit( get_template_directory_uri() ) . 'inc/customizer-includes/upgrade-button/customize-controls.css' );
	}
}
