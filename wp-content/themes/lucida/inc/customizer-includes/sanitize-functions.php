 ...
 * @since Lucida 0.1
 */
function lucida_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 * @since Lucida 0.1
 */
function lucida_sanitize_custom_css( $input ) {
	if ( '' != $input  ) {
 ...
 */
function lucida_sanitize_image( $image, $setting ) {
	/*
 ...
 * @since Lucida 0.1
 */
function lucida_sanitize_page( $input ) {
 ...
 * @since Lucida 0.1
 */
function lucida_sanitize_category_list( $input ) {
	if ( '' != $input  ) {
		if( in_array( 0, $input ) ) {
			return '0';
		}
 ...
 *                    the setting default.
 */
function lucida_sanitize_number_range( $number, $setting ) {
 ...
 *
 * @see lucida_sanitize_select()               https://developer.wordpress.org/reference/functions/lucida_sanitize_select/
 ...
 */
function lucida_sanitize_select( $input, $setting ) {
 ...
 * @since Lucida 0.1
 */
function lucida_sanitize_important_link() {
	return false;
}